...
export const getIndustries = () => {
    return Industries.map(item=>({label: item, value: item}))
}
...
export const ProvinceCityData = [
    ...
    {
        name: '内蒙古', code: "150000", cities: [{name: '全部', code: "150000"},
    ...
    {
        name: '广西省', code: "450000", cities: [{name: '全部', code: "450000"},
    ...
    {
        name: '西藏省', code: "540000", cities: [{name: '全部', code: "540000"},
    ...
    {
        name: '宁夏省', code: "640000", cities: [{name: '全部', code: "640000"},
    ...
    {
        name: '新疆省', code: "650000", cities: [{name: '全部', code: "650000"},
